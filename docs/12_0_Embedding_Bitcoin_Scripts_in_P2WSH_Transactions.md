...
* [Section One: Understanding the Foundation of P2SH & P2WSH](12_1_Understanding_the_Foundation_of_P2WSH.md)
* [Section Two: Building the Structure of P2SH & P2WSH](12_2_Building_the_Structure_of_P2WSH.md)  
* [Section Three: Running a Bitcoin Script with P2SH or P2WSH](12_3_Running_a_Bitcoin_Script_with_P2WSH.md)
* [Section Four: Scripting a Multisig](12_4_Scripting_a_Multisig.md)
* [Section Five: Spending a P2SH or P2WSH Transaction](12_5_Spending_a_P2WSH_Transaction.md)
