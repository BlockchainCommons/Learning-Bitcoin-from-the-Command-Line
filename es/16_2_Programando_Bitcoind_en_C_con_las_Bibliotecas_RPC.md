...
### Planifique tu futuro

Dado que este es su primer programa funcional en C, intentaremos mantenerlo simple (KISS). Si estuviéramos produciendo un programa de producción real, al menos querríamos hacer lo siguiente:


1. Pruebe y / o desinfecte las entradas
...
Obviamente, necesitará tener todas sus variables listas nuevamente, como se discutió en [§15.1: Acceso a Bitcoind con C](15_1_Accessing_Bitcoind_with_C.md). También necesita inicializar su biblioteca, conectar su cliente RPC y preparar su objeto de respuesta:
