...
* [6.0: Expanding Bitcoin Transactions](6_0_Expanding_Bitcoin_Transactions.md) — Pending
  * [6.1: Sending a Transaction with a Multsig](6_1_Sending_a_Transaction_with_a_Multisig.md) — Pending
  * [6.2: Sending a Transaction with a Locktime](6_2_Sending_a_Transaction_with_a_Locktime.md) — Needs Reorganization
  * [6.3: Sending a Transaction with Data](6_3_Sending_a_Transaction_with_Data.md) — Needs Reorganization
