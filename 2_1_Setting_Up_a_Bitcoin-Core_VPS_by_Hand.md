...
If you want to instead have a script do the setup for you, specifically at linode.com, read the parallel HOWTO file, [2B - Setting up a Bitcoin-Core VPS with StackScript](./2_1_Setting_Up_a_Bitcoin-Core_VPS_with_StackScript.md).
